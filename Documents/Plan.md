...
1. Покупка туров. API-тест. Позитивный сценарий (карта валидная, статус APPROVED)
...
2. Покупка туров. API-тест. Негативный сценарий (карта невалидная, статус DECLINED)
    - Нажать кнопку "Купить"
...
3. Покупка туров. API-тест. Негативный сценарий (карта с правильными данными, но с номером, отличным от валидной/ невалидной карты)
    - Нажать кнопку "Купить"
...
1. Оформление кредита. API-тест. Позитивный сценарий (карта валидная, статус APPROVED)
...
2. Оформление кредита. API-тест. Негативный сценарий (карта невалидная, статус DECLINED)
    - Нажать кнопку "Купить в кредит"
...
3. Оформление кредита. API-тест. Негативный сценарий (карта с правильными данными, но с номером, отличным от валидной/ невалидной карты)
    - Нажать кнопку "Купить в кредит"
    - Ввести данные валидной карты (кроме номера)
    - В поле "Номер карты" ввести: 4444 4444 4444 4443
    - Подтвердить ввод (нажать кнопку «Продолжить»)
