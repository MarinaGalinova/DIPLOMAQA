...
3. Приложение Марракэш: проверка корректности ввода данных для дебетовых карт (UI)
4. Приложение Марракэш, проверка корректности ввода данных для кредитных карт (UI)
